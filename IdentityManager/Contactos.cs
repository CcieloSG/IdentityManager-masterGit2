<html>
<head>
	<title>Desplegable de Provedores</title>
	<meta http-equiv="content-type" content="text/html;charset=utf-8">
</head>
<body>
<div id="contenedor">
	<h2 id="encabezado">Provedores</h2>
	<form id="formulario1" name="formulario1" method="post">
		<h3>Provedor de plantas</h3>
		<input type="id" name="nombre" value="1">Rosales<br>
		<input type="id" name="nombre" value="2">Suculentas<br>
        <input type="id" name="nombre" value="3">Arbustos<br>
        <input type="id" name="nombre" value="4">Arboles<br>
        <input type="id" name="nombre" value="5">Matas<br>
        <input type="id" name="nombre" value="6">Llervas<br>
